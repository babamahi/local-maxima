...
HD_PWD='C:/Users/baba/LSI_template/LSI_template.runs/main_design_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_design_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_design_zynq_ultra_ps_e_0_0.tcl
