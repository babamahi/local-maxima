...
HD_PWD='C:/Users/baba/LSI_template/LSI_template.runs/design_1_axi_vip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_vip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_vip_0_1.tcl
