...
REM
REM Generated by Vivado on Tue Jan 10 13:19:06 +0900 2023
...
call xvlog  --incr --relax -L uvm -L axi_vip_v1_1_12 -L zynq_ultra_ps_e_vip_v1_0_12 -L xilinx_vip -prj tb_vlog.prj -log xvlog.log
